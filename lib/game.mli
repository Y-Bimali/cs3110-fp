...
val draw_card : t -> int ref-> t * string option
...
val s_to_f : t -> int ref-> t * string option
...
val s_to_t : t -> int -> int ref-> t * string option
...
val move_tableau_card_to_foundation : t -> int ->int ref->  t * string option
...
val move_card_from_foundation_to_tableau : t -> int -> int ->int ref->  t * string option
...
val t_to_t : t -> string -> string -> string -> int ref-> t * string option
(** [t_to_t g c1 c2 i] is (g, opt) where g is the game that could have been
